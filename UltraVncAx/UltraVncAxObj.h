...
public:
	...
	STDMETHOD(get_DSM)(/*[out, retval]*/ BSTR *pVal);
	STDMETHOD(put_DSM)(/*[in]*/ BSTR newVal);
	STDMETHOD(get_Connected)(/*[out, retval]*/ BOOL *pVal);
	STDMETHOD(Disconnect)();
	STDMETHOD(Connect)();
	STDMETHOD(Initialize)( /*[in]*/ BSTR cmdText, /*[out, retval]*/ BOOL *pRetVal );
...
protected:
	...
	charstring			m_csUserName;
	charstring			m_csPassword;
	charstring			m_csDomain;
	charstring			m_csDSM;
